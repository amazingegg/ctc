...
public class OrderAppearFragment extends LazyFragment implements OnRefreshListener, BaseQuickAdapter.OnItemChildClickListener, BaseQuickAdapter.OnItemClickListener, MyOrderActivity.OnCurrencyClickListener {
    private static final String TAG = "OrderAppearFragment";
    // 这里的参数只是一个举例可以根据需求更改
    private String name;
     ...
     * @return Fragment的实例.
     */
    public static OrderAppearFragment newInstance(String param1) {
        OrderAppearFragment fragment = new OrderAppearFragment();
    ...
    private void getListData() {
        ...
        String status = Integer.toString(Constants.ORDER_TYPE_APPEAR);
    ...
    private void appear(int position) {
       ...
       NetUtils.put(Url.myAppeal, param, new NetUtils.StringCallBack() {
           @Override
           public void onError(Call call, Exception e, int id) {
