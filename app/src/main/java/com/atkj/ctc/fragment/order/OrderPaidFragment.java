...
public class OrderPaidFragment extends LazyFragment implements OnRefreshListener, BaseQuickAdapter.OnItemChildClickListener, BaseQuickAdapter.OnItemClickListener, MyOrderActivity.OnCurrencyClickListener {
    private static final String TAG = "OrderPaidFragment";
    // 这里的参数只是一个举例可以根据需求更改
    private String name;
     ...
     * @return Fragment的实例.
     */
    public static OrderPaidFragment newInstance(String param1) {
        OrderPaidFragment fragment = new OrderPaidFragment();
    ...
    private void getListData() {
        ...
        String status = Integer.toString(Constants.ORDER_TYPE_PAID);
