...
public class PublishCompletedFragment extends LazyFragment implements OnRefreshListener, BaseQuickAdapter.OnItemChildClickListener, MyOrderActivity.OnCurrencyClickListener {
    private static final String TAG = "PublishCompletedFragment";
    // 这里的参数只是一个举例可以根据需求更改
    private String name;
     ...
     * @return Fragment的实例.
     */
    public static PublishCompletedFragment newInstance(String param1) {
        PublishCompletedFragment fragment = new PublishCompletedFragment();
    ...
    private void getListData() {
        ...
        param.put("status", Integer.toString(Constants.PUBLISH_TYPE_COMPLETED));
