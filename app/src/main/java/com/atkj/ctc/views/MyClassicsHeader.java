...
public class MyClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    public MyClassicsHeader(Context context) {
        super(context);
        REFRESH_HEADER_PULLDOWN = context.getString(R.string.a461);
        REFRESH_HEADER_REFRESHING = context.getString(R.string.a462);
        REFRESH_HEADER_LOADING = context.getString(R.string.a463);
        REFRESH_HEADER_RELEASE = context.getString(R.string.a464);
        REFRESH_HEADER_FINISH = context.getString(R.string.a465);
        REFRESH_HEADER_FAILED = context.getString(R.string.a466);
        REFRESH_HEADER_LASTTIME = context.getString(R.string.a467);
        mFormat = new SimpleDateFormat("M-d HH:mm", Locale.CHINA);
...
//    }
    ...
    public MyClassicsHeader setLastUpdateTime(Date time) {
        mLastTime = time;
        mLastUpdateText.setText(REFRESH_HEADER_LASTTIME + mFormat.format(time));
